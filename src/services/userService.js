...
const filterHistoriesBooking = (data) => {
  return axios.post(`/api/filter-history-for-user`, data);
};
//delete booking s1 s2
const deleteBookingS = (data) => {
  return axios.post(`/api/deleteBookingS`, data);
};
...
//history doctor
const filterHistoriesDoctor = (data) => {
  return axios.post(`/api/filter-history-doctor`, data);
};
//history admin
const filterHistoriesAll = (data) => {
  return axios.post(`/api/filter-history-all`, data);
};
...
export {
  ...
  filterRestoreUsers,
  handleRestoreUser,
  deleteRestoreUser, filterHistoriesDoctor, filterHistoriesAll, deleteSchedule, filterHistoriesBooking, deleteBookingS
};
