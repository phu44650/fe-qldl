    ...
    return (
      <div className="manage-specialty-container">
        ...
        <div className="add-new-specialty row">
          ...
          <div className="col-12 mt-20"><FormattedMessage id="admin.manage-specialty.markdownVi" />
            <MdEditor
              style={{ height: "300px" }}
          ...
          <div className="col-12 mt-20"><FormattedMessage id="admin.manage-specialty.markdownEn" />
            <MdEditor
              style={{ height: "300px" }}
              renderHTML={(text) => mdParser.render(text)}
