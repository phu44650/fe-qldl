...
class CreateSpecialty extends Component {
  ...
  chechValidateInput = () => {
    ...
    let arrCheck = ["name", "nameEn", "imageBase64", "descriptionHTML", "descriptionMarkdown", "descriptionHTMLEn", "descriptionMarkdownEn"]
    ...
    return (
      <div className="manage-specialty-container">
        ...
        <div className="add-new-specialty row">
          ...
          <div className="col-6 form-group">
            <label><FormattedMessage id="admin.manage-specialty.specialty-nameEn" /></label>
            <input
              className="form-control"
              type="text"
          ...
          <div className="col-12 my-5">
            <label><FormattedMessage id="admin.manage-specialty.markdownVi" /></label>
            <MdEditor
              style={{ height: "300px" }}
          ...
          <div className="col-12 my-5">
            <label><FormattedMessage id="admin.manage-specialty.markdownEn" /></label>
            <MdEditor
