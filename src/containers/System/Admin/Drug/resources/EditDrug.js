            ...
            <div className="row">
                <div className="col-6">
                    <div className="form-group">
                        <label htmlFor="exampleInputEmail1"> <FormattedMessage id={"admin.manage-drug.name-drug"} /></label>
                        <input type="text" value={name} className="form-control" id="name" placeholder="Enter name drug"
                            onChange={(event) =>
                                handleOnChangeInput(event)
                            }
                        />
                    </div>
                    <button type="submit" className="btn btn-primary" onClick={() => handleEditDrug()}><FormattedMessage id={"admin.manage-drug.update"} /></button>
                </div>
            </div>
