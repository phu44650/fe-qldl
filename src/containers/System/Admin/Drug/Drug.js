...
export default function Drug() {
  ...
  return (
    <div>
      ...
      <div className="row mb-60 p-15" >
        <div className="col-12">
          <h3 className="mt-8"><FormattedMessage id="medical-history.filters" /></h3>
        </div>
        <div className="col-3">
          <div className="form-group">
            <label htmlFor="name"><FormattedMessage id="admin.manage-doctor.name" /></label>
            <input type="text" value={name} className="form-control" id="name" placeholder=""
              onChange={(event) =>
        ...
        <div className="col-12"><button type="submit" className="btn btn-primary pointer" onClick={() => handleFilter()}><FormattedMessage id="medical-history.apply" /></button></div>
      </div>
