    ...
    return (
      <div>
        ...
        <div className="row">
          ...
          <div className="col-12">
            <button onClick={() => this.handleFilterDoctors()} type="button" className="btn btn-primary mr-5"><FormattedMessage id="medical-history.apply" /></button>
              ...
              listDoctorsRaw.map((doctor, index) => {
                ...
                return (
                  <tr key={index}>
                    ...
                    <td>{language == "en" ? doctor.Doctor_Infor.specialtyData.nameEn : doctor.Doctor_Infor.specialtyData.name}</td>
                    <td>{language == "en" ? doctor.Doctor_Infor.clinicData.nameEn : doctor.Doctor_Infor.clinicData.name}</td>
