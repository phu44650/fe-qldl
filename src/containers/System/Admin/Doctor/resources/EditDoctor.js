  ...
  render() {
    ...
    return (
      <div className="manage-doctor-container">
        ...
        <div className="row">
          ...
          <div className="col-7 form-group">
            ...
            <textarea
              className="form-control"
              onChange={(event) =>
                this.handleOnChangeText(event, "descriptionEn")
              }
            ...
            >
              <option value="">{this.props.language == "en" ? "Choose price" : "Chọn giá"}</option>
              {
                this.state.listPrice.map((price) => {
                  return (<option key={price.value} value={price.value}>{price.label}</option>)
                })
              }
            </select>
          </div>
        ...
        <div className="row">
            ...
            >
              <option value="">{this.props.language == "en" ? "Choose specialty" : "Chọn chuyên khoa"}</option>
              {
                this.state.listSpecialty.map((specialty) => {
                  return (<option key={specialty.value} value={specialty.value}>{specialty.label}</option>)
                })
              }
            </select>
          ...
          <div className="col-4 form-group">
            ...
            >
              ...
              {/* {this.state.listClinic.map((clinic, index) => (
                <option key={index} value={clinic.value}>
                  {clinic.label}
                </option>
              ))} */}
        ...
        <div className="markdown-vi my-5 ">  <FormattedMessage id="admin.manage-doctor.markdownVi" />
          <div className="manage-doctor-editor my-5">
            <MdEditor
              style={{ height: "300px" }}
        ...
        <div className="markdown-en my-3 "> <FormattedMessage id="admin.manage-doctor.markdownEn" />
          <div className="manage-doctor-editor my-5">
            <MdEditor
              style={{ height: "300px" }}
              renderHTML={(text) => mdParser.render(text)}
