...
import DoctorScheduleEx from "../../Patient/Doctor/DoctorScheduleEx";
class ManageSchedule extends Component {
  ...
  handleChangeSelect = async (selectedOption) => {
    ...
    console.log(this.state.selectedDoctor.id);
  };
        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-12">
              ...
              <div className="m-s-title">
                <FormattedMessage id="manage-schedule.title2" />
              </div>
              <DoctorScheduleEx
                doctorIdFromParent={this.state.selectedDoctor.value}
