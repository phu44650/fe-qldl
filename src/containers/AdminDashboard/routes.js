...
import MyAccount from "../Profile/resources/MyAccount";
import AllHistory from "../Profile/resources/AllHistory"

import DoctocHistory from "../Profile/resources/DoctorHistory"
// ----------------------------------------------------------------------
  ...
  return useRoutes([
    {
      ...
      children: [
        ...
        { path: "user", element: <UserRedux /> }, //loc bang user*trong day chua components chua bang ủe
        { path: "user/create", element: <CreateUser /> }, //create user
        { path: "user/edit/:userId", element: <EditUser /> }, //edit user

        { path: "restore-user", element: <RestoreUser /> }, //
        ...
        { path: "manage-history", element: <AllHistory /> },//quan ly lich su 
        ...
        //duong dan mac dinh khi dang nhap vao
        { path: "", element: <Navigate to={userInfo.roleId === "R1" ? "/admin-dashboard/app" : "/admin-dashboard/doctor/manage-patient"} replace={true} /> },
    ...
    },
    {
      ...
      children: [
        ...
        { path: "history", element: <DoctocHistory /> },
        { path: "account", element: <MyAccount /> },
